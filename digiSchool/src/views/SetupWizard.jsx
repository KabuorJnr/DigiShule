    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div className="card" style={{ maxWidth: 600, width: '100%', background: '#fff', overflow: 'hidden' }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, #10B981, #059669)', color: '#fff', padding: '30px 40px' }}>
          ...
          <p style={{ margin: 0, opacity: 0.9 }}>Welcome to <img src="/eduone-logo.png" alt="EduOne" style={{ height: '1.2em', verticalAlign: 'middle', background: 'white', borderRadius: 4, padding: '2px 4px' }} />. Let's pre-configure your school profile before onboarding users.</p>
        </div>
